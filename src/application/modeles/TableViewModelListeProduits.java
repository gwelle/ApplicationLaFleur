 ...
 *
 */
public class TableViewModelListeProduits {
	 ...
	 * @param vues
	 */
	public TableViewModelListeProduits(Vues vues) {
		System.out.println("TableViewModelListeProduits::TableViewModelListeProduits()");
		this.vue = vues ;
	}
